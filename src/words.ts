...
export const WORDS: Record<string, WordMetadata> = {
  ...
  DROP: word({
    ...
    category: "stack",
    stack: "object ->",
    description: "Drop level 1.",
    source: "rpl26 Milestone 1",
    examples: ["1 2 DROP"],
    keywords: ["remove", "discard", "stack"]
  }),
  ...
  SWAP: word({
    ...
    source: "rpl26 Milestone 1",
    examples: ["1 2 SWAP"],
    keywords: ["exchange", "reorder", "stack"]
  }),
  OVER: word({
    name: "OVER",
    category: "stack",
    stack: "object1 object2 -> object1 object2 object1",
    description: "Copy level 2.",
    source: "rpl26 Milestone 1",
    examples: ["1 2 OVER"],
    keywords: ["copy", "level 2", "stack"]
  }),
  ROT: word({
    name: "ROT",
    category: "stack",
  ...
  SIZE: word({
    ...
    source: "rpl26 Milestone 2",
    examples: ["{ 1 2 3 } SIZE"],
    keywords: ["length", "count", "list"]
  }),
  GET: word({
    name: "GET",
    category: "list",
    stack: "list index -> object",
    description: "Get a one-based list element.",
    source: "rpl26 Milestone 2",
    examples: ["{ 10 20 30 } 2 GET"],
    keywords: ["index", "element", "lookup"]
  }),
  ...
  IF: word({
    name: "IF",
    category: "control",
    stack: "IF test THEN body END",
    description: "Begin an HP-style conditional.",
    source: "HP 48G control-flow notes",
    examples: ["IF 1 THEN 42 END"],
    keywords: ["conditional", "branch", "test"]
  }),
  ...
  HEAD: word({
    name: "HEAD",
    category: "object",
    stack: "list|string -> object|string",
    description: "Return the first list element or first string character.",
    source: "HP 48G object library notes",
    examples: ["{ 4 5 6 } HEAD", "\"abc\" HEAD"],
    keywords: ["first", "front", "list", "string"]
  }),
  ...
  SUB: word({
    name: "SUB",
    category: "object",
    stack: "list|string start end -> list|string",
    description: "Extract a one-based inclusive subrange.",
    source: "HP 48G object library notes",
    examples: ["\"abcdef\" 2 4 SUB"],
    keywords: ["slice", "range", "substring"]
  }),
  ...
  "->STR": word({
    ...
    category: "object",
    stack: "object -> string",
    description: "Convert an object to display string form.",
    source: "HP 48G object library notes",
    examples: ["{ 1 2 } ->STR"],
    keywords: ["string", "display", "convert"],
    aliases: ["to-string"]
  }),
  "->TAG": word({
    name: "->TAG",
    category: "object",
    stack: "object name|string -> tagged",
    description: "Create a tagged object.",
    source: "HP 48G object library notes",
    examples: ["5 \"answer\" ->TAG"],
    keywords: ["tag", "label", "annotate"],
    aliases: ["to-tag"]
  })
};
